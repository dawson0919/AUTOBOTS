...
const STRATEGY_PARAMS = {
  ...
  tripleCCI:  { slMult: 1.5, tpMult: 2.5, trailing: true, trailingEMA: 15 },
};
...
function main() {
  ...
  const strategyMap = {
    ...
    tripleCCI:  () => new TripleCCIStrategy({
      cciFast: 14, cciMid: 30, cciSlow: 70,
      mfiLength: 14, emaTrend: 50, emaTrailing: 15,
      atrSL: 1.5, atrTPActivate: 2.5,
    }),
  };
